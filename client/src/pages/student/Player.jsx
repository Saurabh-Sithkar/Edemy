                ...
                <div key={index} className='border border-gray-300 bg-white mb-2
                 rounded'>
                  ...
                  select-none' onClick={()=> toggleSection(index)}>
                   ...
                   progressData.markLectureAsCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className='w-4
                                              h-4 mt-1' />
               ...
               <YouTube videoId={playerData.lectureUrl.split('/').pop()}
                ...
                <div className='flex justify-between items-center mt-1'>
                  ...
                  <button onClick={()=> markLectureAsCompleted(playerData.lectureId)}
                   ...
                   progressData.markLectureAsCompleted.includes(playerData.lectureId) ? 'Completed':'Mark Completed'}</button>
                </div>
            </div>
          )
          :
